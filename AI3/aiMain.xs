...
void setUnitPickerPreference(int upID = -1)
{
    ...
    if (civIsAsian() == true)
    { // Asians need to stop trying to build saloon units
...
{
    if (civIsAsian() == false)
    { // don't need to be here unless we're Asian
        return;
    }
...
minInterval 1
{
    ...
    case 0: // Init arrays
    {
        ...
        { // Set priorities for the cards based on unit type.
            ...
            {
                if ((tech == cTechYPHCShipDaimyoAizu) || (tech == cTechYPHCShipDaimyoSatsuma) || (tech == cTechYPHCShipDaimyoTokushima) || (tech == cTechYPHCShipShogunate) || (tech == cTechYPSPCHCShipDaimyoKiyomasa) || (tech == cTechYPSPCHCShipDaimyoMasamune) || (tech == cTechYPSPCHCShipDaimyoTadaoki))
                {
...
rule monitorScores
inactive
        minInterval 60 group tcComplete
{
